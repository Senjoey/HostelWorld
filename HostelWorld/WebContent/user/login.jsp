    ...
    function login(){
		if(document.getElementById("password").value=="")
			...
			$.ajax({
				...
				data:{type:"member", id:document.getElementById("userid").value,password:document.getElementById("password").value},
    ...
    <!--  <div style="width:100%; height:auto;">
      ...
      <div style="font-family:Lucida Console;font-size: 2em; padding-top:10%">
        ...
        <span class="input input--hoshi input_center" >
            <input class="input__field input__field--hoshi" type="text" id="userid"/>
            <label class="input__label input__label--hoshi input__label--hoshi-color-1" >
                <span class="input__label-content input__label-content--hoshi">User ID</span>
            </label>
        </span>
        <span class="input input--hoshi input_center">
